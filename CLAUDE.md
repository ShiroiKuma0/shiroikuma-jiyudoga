...
- **Upstream tracking: `git`** — for **both** upstreams. `master` mirrors FreeTube's *development
  ...
  `0.25.1.1.2026-08-02.gdc7c4e2e.2026-07-30.gfea7a050+007`. Each sha is
